...
defineGetter(req, 'protocol', function protocol(){
  // Cache protocol to avoid re-computing
...
defineGetter(req, 'host', function host(){
  // Cache host to avoid re-computing
  if (this._cachedHost !== undefined) {
    return this._cachedHost;
  }
  ...
  this._cachedHost = val || undefined;
  return this._cachedHost;
});
...
defineGetter(req, 'hostname', function hostname(){
  // Cache hostname to avoid re-computing
  if (this._cachedHostname !== undefined) {
    return this._cachedHostname;
  }

  var host = this.host;

  if (!host) {
    this._cachedHostname = undefined;
    return this._cachedHostname;
  }
